...
<footer class="site-footer" role="contentinfo">
  ...
  function initPWA(){
    ...
    if(!document.querySelector('link[rel="icon"]')){
      ...
      fi.rel = 'icon'; fi.type = 'image/svg+xml'; fi.href = 'favicon.svg?v=5';
      document.head.appendChild(fi);
    }
    // Apple touch icon
    if(!document.querySelector('link[rel="apple-touch-icon"]')){
      var ai = document.createElement('link');
      ai.rel = 'apple-touch-icon'; ai.href = 'favicon.svg?v=5';
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    (function(){
      ...
      var lastX=0,lastY=0,lastTarget=null,rafPending=false;
      function applySpot(){
        rafPending=false;
        var t=lastTarget;
        ...
        c.style.setProperty('--mx',(lastX-r.left)+'px');
        c.style.setProperty('--my',(lastY-r.top)+'px');
      }
